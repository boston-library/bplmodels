      ...
      case hiergeo_hash[:country]
        when 'United States','Canada'
          if hiergeo_hash[:state] || hiergeo_hash[:province]
            placename[0] = hiergeo_hash[:city_section].presence || hiergeo_hash[:city].presence || hiergeo_hash[:island].presence
            ...
            placename[0] = hiergeo_hash[:area].presence || hiergeo_hash[:region].presence || hiergeo_hash[:territory].presence || hiergeo_hash[:country].presence
          end
        else
          placename[0] = hiergeo_hash[:city_section].presence || hiergeo_hash[:city].presence || hiergeo_hash[:island].presence || hiergeo_hash[:state].presence || hiergeo_hash[:province].presence || hiergeo_hash[:area].presence || hiergeo_hash[:region].presence || hiergeo_hash[:territory].presence
